        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="mt-1 text-sm text-[#4A4A4A]">
                        Here’s an overview of your learning progress and new
                        opportunities.
                    </p>
                </div>
            ...
            <Card>
                ...
                {enrolledCourses.length === 0 ? (
                    <p className="text-sm text-[#4A4A4A]">
                        You’re not enrolled in any courses yet. Start by
            ...
            <Card>
                ...
                {recommendations.length === 0 ? (
                    <p className="text-sm text-[#4A4A4A]">
                        No recommendations yet. Enroll in some courses to get
                        smarter suggestions.
                    </p>
                ) : (
            ...
            <Card>
                ...
                {skillSwapMatches.length === 0 ? (
                    <p className="text-sm text-[#4A4A4A]">
                        No matches yet. Update your profile with skills you can
                        offer and skills you want to learn.
                    </p>
                ) : (
                    <div className="space-y-3">
