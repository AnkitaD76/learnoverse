...
export const WalletProvider = ({ children }) => {
  ...
  const refreshExchangeRates = useCallback(async () => {
    ...
    try {
      ...
      setExchangeRates([
        { currency: 'USD', rate: 100, description: '1 USD = 100 points' },
        { currency: 'BDT', rate: 1, description: '1 BDT = 1 point' },
        { currency: 'EUR', rate: 110, description: '1 EUR = 110 points' },
        { currency: 'GBP', rate: 125, description: '1 GBP = 125 points' },
      ]);
    }
  }, [isAuthenticated]);
