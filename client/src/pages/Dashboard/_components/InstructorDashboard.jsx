    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[#4A4A4A]">Total Courses</p>
          </div>
        </Card>

        <Card className="p-6">
          <div className="text-center">
            <p className="text-4xl font-bold text-[#1EB5A6]">{totalStudents}</p>
            <p className="mt-2 text-sm text-[#4A4A4A]">Total Students</p>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[#4A4A4A]">Total Revenue</p>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[#4A4A4A]">Pending Reviews</p>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-[#1A1A1A]">My Courses</h3>
            ...
            <table className="w-full text-sm">
              <thead className="border-b border-gray-200">
                <tr className="text-left">
                  <th className="pb-3 font-semibold text-[#1A1A1A]">Course</th>
                  <th className="pb-3 font-semibold text-[#1A1A1A]">Student</th>
                  <th className="pb-3 font-semibold text-[#1A1A1A]">Amount</th>
                  <th className="pb-3 font-semibold text-[#1A1A1A]">Date</th>
                </tr>
              </thead>
              <tbody>
                {recentSales.map(sale => (
                  ...
                  >
                    <td className="py-3 text-[#1A1A1A]">{sale.course}</td>
                    <td className="py-3 text-[#4A4A4A]">{sale.student}</td>
                    <td className="py-3 font-semibold text-[#1EB5A6]">
                      ${sale.amount}
                    </td>
                    <td className="py-3 text-[#4A4A4A]">{sale.date}</td>
                  </tr>
                ))}
              </tbody>
            </table>
