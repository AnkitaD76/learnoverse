...
const SellPoints = () => {
    ...
    const isFormValid = () => {
        const hasAmount =
            formData.cash_amount > 0 && formData.points_amount > 0;
        const hasMethod = formData.payout_method;
        const hasSufficientPoints = hasSufficientBalance(
            formData.points_amount
        );
        ...
        return (
            hasAmount && hasMethod && hasSufficientPoints && hasRequiredDetails
        );
    };
                    ...
                    {transactionResult.success ? (
                        <>
                            ...
                            <p className="result-message">
                                Your payout request has been submitted. Points
                                have been deducted from your balance and will be
                                held until the payout is processed.
                            </p>
                            ...
                            <div className="warning-box">
                                ...
                                <p>
                                    ...
                                    {
                                        payoutMethods.find(
                                            m => m.id === formData.payout_method
                                        )?.description
                                    }
                                    . You'll be notified when the payout is
                                    completed.
                                </p>
                            </div>
                        ...
                        <>
                            ...
                            <div className="info-box">
                                <p>
                                    Your points have <strong>not</strong> been
                                    deducted. You can try again or contact
    ...
    return (
        <div className="sell-points-page">
            ...
            <div className="warning-box important">
                ...
                <ul>
                    <li>
                        Points will be <strong>deducted immediately</strong>{' '}
                    ...
                    <li>
                        If your payout is rejected, points will be{' '}
                        <strong>restored</strong> to your balance
                    </li>
                    <li>
                        Make sure your payout details are correct before
                        submitting
                    </li>
                </ul>
            </div>
                    ...
                    <div className="payout-methods">
                        {payoutMethods.map(method => (
                            <div
                                ...
                                onClick={() =>
                                    handlePayoutMethodChange(method.id)
                                }
                            >
                                <input
                                    type="radio"
                        ...
                        <div className="payout-details">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    value={
                                        formData.payout_details.swift_code || ''
                                    }
                                    onChange={e =>
                                        handlePayoutDetailsChange(
                                            'swift_code',
                        ...
                        <div className="payout-details">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="email"
                                    value={
                                        formData.payout_details.paypal_email ||
                                        ''
                                    }
                                    onChange={e =>
                                        handlePayoutDetailsChange(
                        ...
                        <div className="summary-details">
                            <div className="summary-row">
                                ...
                                <span className="amount">
                                    {formData.points_amount.toLocaleString()}{' '}
                                    points
                                </span>
                            </div>
                            <div className="summary-row">
                            ...
                            <div className="summary-row">
                                ...
                                <span>
                                    1 {formData.currency} = {formData.rate}{' '}
                                    points
                                </span>
                            </div>
                            <div className="summary-row">
