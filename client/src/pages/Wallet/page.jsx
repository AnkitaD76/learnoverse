                ...
                {isLoading && !recentTransactions.length ? (
                    ...
                    <div className="empty-state">
                        ...
                        <p className="empty-subtitle">
                            Buy points or enroll in courses to see transactions
                            here
                        </p>
                    </div>
                )}
            ...
            <section className="wallet-info">
                ...
                <div className="info-grid">
                    <div className="info-card">
                        <h3>💰 Buy Points</h3>
                        <p>
                            Purchase points using USD, BDT, EUR, or GBP. Points
                            are credited immediately after payment.
                        </p>
                    </div>
                    <div className="info-card">
                        <h3>📚 Use Points</h3>
                        <p>
                            Enroll in courses using points instead of
                            traditional payment methods. Points are deducted
                    ...
                    <div className="info-card">
                        <h3>💸 Sell Points</h3>
                        <p>
                            Request a payout to convert points back to cash.
                            Points are held until payout is processed.
                        </p>
                    </div>
                    <div className="info-card">
                        <h3>🔄 Exchange Rates</h3>
                        <p>
                            Rates are set by administrators and may vary by
                            currency. Check current rates before transactions.
                        </p>
                    </div>
                </div>
            </section>
